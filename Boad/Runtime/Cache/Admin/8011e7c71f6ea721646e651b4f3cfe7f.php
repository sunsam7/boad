...
<body>
<form id="btitle" name="btitle" method="post" action="/boad/Admin/Index/boadtitle_save">
<table class="table">
	<tr>
    	<td scope="row"><a href="/boad/Admin">返回列表</a></td>
    	<td scope="row" class="text_right"><a href="/boad/Admin/Index/boadtitle">新增直播专题</a></td>
    </tr>
  <tr>
