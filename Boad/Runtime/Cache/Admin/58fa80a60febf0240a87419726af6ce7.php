...
<tr>
    	<td colspan="3" ></td>
    	<td colspan="3" class="text_right"><a href="/boad/Admin/Login/logout">退出</a></td>
    </tr>
	<tr>
    	<td colspan="3" ></td>
    	<td colspan="3" class="text_right"><a href="/boad/Admin/Index/boadtitle">新建专题</a></td>
    </tr>
  <tr>
    <th scope="col">ID</th>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
    ...
    <td><a href="/boad/<?php echo ($vo["id"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a></td>
    <td><?php echo ($vo["author"]); ?></td>
    <td><?php echo ($vo["status"]); ?></td>
    <td><?php echo ($vo["time"]); ?></td>
    <td><a href="/boad/Admin/Index/boadlist/id/<?php echo ($vo["id"]); ?>">内容</a>  <a href="/boad/Admin/Index/boadtitle/id/<?php echo ($vo["id"]); ?>">修改</a>  <a href="javascript:void(0);" onclick="delete_data(this,<?php echo ($vo["id"]); ?>);">删除</a></td>
...
function delete_data(obj,id){
	...
	if(confirm("确定要删除这个专题吗？专题的内容将会同步删除。")){
		jQuery.post("/boad/Admin/Index/ajax_act/", {
