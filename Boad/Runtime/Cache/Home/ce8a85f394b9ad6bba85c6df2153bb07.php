...
<link href="/wish/Public/css/style.css" rel="stylesheet" type="text/css"> 
</head>
 ...
 var wbpic = encodeURI('<?php echo ($title_info['titlepic']); ?>');
  ...
  <div class="body" id="J-main">
   ...
   <div class="toTop-btn" title="回顶部" onclick="window.scrollTo(0, 0);" style="display: none;"></div>
      ...
      <script type="text/javascript" src="/wish/Public/js/a_function.js"></script>
      <script type="text/javascript">
      var dig_post_file = '/wish/Home/Index/ajax_act/';
      var perpage = 5;
      var page = 1;
